...
`matching.validate_row()` - Only "Cultivation tasks and PPP-ferti" (template_id = "cultivation_tasks_v1")
"""
...
def parse_cultivation_tasks_v1(uploaded_file) -> list[dict]:
    ...
    for excel_row_number, record in data.iterrows():
        ...
        row = {
            ...
            # Harvest quantity lives in a different column than Input quantity
